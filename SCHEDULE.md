...
* 统计四天采用加速度计值互相关方法实现时间同步
  * Pixel3 同参考真值的时间差估计 0.575 ~ 0.590
  * Mate30 同参考真值的时间差估计有两个范围 0.045 ~ 0.050 和 0.070 ~ 0.095
  * P20    同参考真值的时间差估计有多个范围 0.150 ~ 0.195 1.195 ~ 1.265 1.220 ~ 1.310 1.490 ~ 1.515

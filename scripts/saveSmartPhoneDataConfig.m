...
kEnvironmentSensorPressureFileNameChar = 'EnvironmentSensorPressure.csv';
kEnvironmentSensorPressureFileNameString = string(kEnvironmentSensorPressureFileNameChar);
...
kValidateSensorFileList = horzcat(kMotionSensorAccelerometerFileNameString,...
    ...
    kEnvironmentSensorPressureFileNameString,...

function [outputFilterState] = filterUpdatePositionMeasurement(inputFilterState,inputPositionMeasurement)
...
inputPositionMeasurementValue = (inputPositionMeasurement{1,1})';
inputPositionMeasurementCovariance = inputPositionMeasurement{1,2};

updateStateMeasurementTransitionH = zeros(3,inputFilterPSize);
updateStateMeasurementTransitionH(:,1:3) = -skew(inputFilterState3Translation);
updateStateMeasurementTransitionH(:,7:9) = eye(3);
updateStateMeasurementTransitionS = updateStateMeasurementTransitionH * inputFilterState8StateCovariance * updateStateMeasurementTransitionH' + inputPositionMeasurementCovariance;
...
updateStateMeasurementTransitionDeltaX = updateStateMeasurementTransitionK * (inputPositionMeasurementValue - inputFilterState3Translation);
...
updateStateCovariance = updateStateMeasurementTransitionIKH * inputFilterState8StateCovariance * updateStateMeasurementTransitionIKH' ...
    + updateStateMeasurementTransitionK * inputPositionMeasurementCovariance * updateStateMeasurementTransitionK';
